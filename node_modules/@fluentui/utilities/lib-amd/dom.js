define(["require", "exports", "tslib", "./dom/IVirtualElement", "./dom/elementContains", "./dom/elementContainsAttribute", "./dom/findElementRecursive", "./dom/getChildren", "./dom/getDocument", "./dom/getFirstVisibleElementFromSelector", "./dom/getParent", "./dom/getRect", "./dom/getVirtualParent", "./dom/getWindow", "./dom/isVirtualElement", "./dom/on", "./dom/portalContainsElement", "./dom/raiseClick", "./dom/setPortalAttribute", "./dom/setVirtualParent"], function (require, exports, tslib_1, IVirtualElement_1, elementContains_1, elementContainsAttribute_1, findElementRecursive_1, getChildren_1, getDocument_1, getFirstVisibleElementFromSelector_1, getParent_1, getRect_1, getVirtualParent_1, getWindow_1, isVirtualElement_1, on_1, portalContainsElement_1, raiseClick_1, setPortalAttribute_1, setVirtualParent_1) {
    "use strict";
    ...
    tslib_1.__exportStar(getFirstVisibleElementFromSelector_1, exports);
